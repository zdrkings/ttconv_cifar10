...
student.eval()
midstep_denoising_student = midstep_denoising_ddim(model=student, beta_1 =1e-4,beta_T=0.028, T=500,w=15.0,stride=1,eta=1)
...
def student_image_editing_sample_ddim(img, labels, level):
