...
teacher.eval()
midstep_denoising_teacher = midstep_denoising_ddim(model=teacher, beta_1 =1e-4,beta_T=0.028, T=500,w=15.0,stride=2,eta=0).to(device)
...
def teacher_image_editing_sample_ddim(img, labels, levels):
